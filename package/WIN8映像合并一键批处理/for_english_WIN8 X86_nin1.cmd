...
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 1 "Windows 8 Professional 32bit" "Windows 8 Professional 32bit"
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 2 "Windows 8 Core 32bit" "Windows 8 Core 32bit"
...
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 3 "Windows 8 Core 32bit [Admin]" "Windows 8 Core 32bit Enabled administrator"
...
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 4 "Windows 8 Professional 32bit [Admin]" "Windows 8 Professional 32bit Enabled administrator"
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 5 "Windows 8 Professional 32bit [Admin] [With Media Center]" "Windows 8 Professional 32bit [With Media Center] Enabled administrator"
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 6 "Windows 8 Professional 32bit [With Media Center]" "Windows 8 Professional 32bit [With Media Center]"


IF EXIST %PART%:\x86ent.wim ( 
   ECHO -------------------������ Win8 Enterprise ӳ����------------------------
   %PART%:\$OEM$\imagex.exe /info %PART%:\x86ent.wim 1 "Windows 8 Enterprise 32bit" "Windows 8 Enterprise 32bit"   
   ...
   DISM /commit-image /MountDir:%PART%:\tempwim /append
   DISM /unmount-Wim /MountDir:%PART%:\tempwim /discard
   %PART%:\$OEM$\imagex.exe /info %PART%:\x86ent.wim 2 "Windows 8 Enterprise 32bit [Admin]" "Windows 8 Enterprise 32bit Enabled administrator"
)
