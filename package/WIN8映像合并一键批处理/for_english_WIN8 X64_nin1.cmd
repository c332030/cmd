...
ECHO.
ECHO     �������������ʼ�Զ��������ڿ�ʼ��Any key to Continue...
pause >nul
...
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 1 "Windows 8 Professional 64bit" "Windows 8 Professional 64bit"
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 2 "Windows 8 Core 64bit" "Windows 8 Core 64bit"
...
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 3 "Windows 8 Core 64bit [Admin]" "Windows 8 Core 64bit Enabled administrator"
...
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 4 "Windows 8 Professional 64bit [Admin]" "Windows 8 Professional 64bit Enabled administrator"
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 5 "Windows 8 Professional 64bit [Admin] [With Media Center]" "Windows 8 Professional 64bit [With Media Center] Enabled administrator"
%PART%:\$OEM$\imagex.exe /info %PART%:\install.wim 6 "Windows 8 Professional 64bit [With Media Center]" "Windows 8 Professional 64bit [With Media Center]"


IF EXIST %PART%:\x64ent.wim ( 
   ECHO -------------------������ Win8 Enterprise ӳ����------------------------
   %PART%:\$OEM$\imagex.exe /info %PART%:\x64ent.wim 1 "Windows 8 Enterprise 64bit" "Windows 8 Enterprise 64bit"   
   ...
   DISM /commit-image /MountDir:%PART%:\tempwim /append
   DISM /unmount-Wim /MountDir:%PART%:\tempwim /discard
   %PART%:\$OEM$\imagex.exe /info %PART%:\x64ent.wim 2 "Windows 8 Enterprise 64bit [Admin]" "Windows 8 Enterprise 64bit Enabled administrator"
)
...
ECHO -------------------����ɿ����ڿ�¼��ISO�ļ� ��------------------------
echo.
echo     �Ƿ�����ISO?  �������������Any key to Continue
echo.
echo     �������Ҫ�������رձ����ڡ�
echo.
